# P/GEN Source Catalog

> Detailed research index for the source intelligence used by the P/GEN prompt archive.
>
> The catalog is an attribution and decision record—not a source-code mirror. P/GEN uses original distilled principles and does not reproduce private, leaked, proprietary, or unauthorized prompts, source code, assets, screenshots, or brand identities.
...
| Source | How P/GEN uses it |
|---|---|
| [Odysseus](https://github.com/odysseus-dev/odysseus) | Conditional agentic-workspace safety: scoped tools, provider adapters, untrusted context, owner-scoped memory, research provenance, and human approval for effectful actions. |
| [Agency Agents](https://github.com/msitarzewski/agency-agents) | Lean specialist review lenses for UX, UI, brand, inclusion, frontend, security, reliability, and UI finish gates. |
| [Karpathy-Inspired Skills](https://github.com/multica-ai/andrej-karpathy-skills) | Assumption visibility, simplicity, surgical changes, and goal-driven verification. |
| [Superpowers](https://github.com/obra/superpowers) | Design/spec/plan/verified-slice/review workflow, TDD, systematic debugging, and completion verification. |
| [Awesome Claude Code](https://github.com/hesreallyhim/awesome-claude-code) | Curated resource discovery with provenance, license, security, privacy, and project-fit gates. |
| [Claude-Mem](https://github.com/thedotmack/claude-mem) | Consented persistent context, progressive retrieval, provenance, privacy exclusion, token budgeting, and citations. |
